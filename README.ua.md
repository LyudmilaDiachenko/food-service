...
- Створено репозиторій `food-service`.
...
- Обов'язково використовуй parcel або webpack на вибір, для збирання та деплоя
  проекта.
...
Нижче вказана розмітка елемента меню яка повинна виходити з шаблоном (дані
